...
/***/ function(module, exports, __webpack_require__) {
	...
	var app = _reactDom2.default.render(_react2.default.createElement(_components.App, null), document.querySelector('#app-container'));

	ipcRenderer.on('openPreset', function (event, path) {
	    try {
	        var preset = JSON.parse(_fs2.default.readFileSync(path, 'utf8'));
	...
	ipcRenderer.on('savePresetAs', function (event, path) {
	    try {
	        _fs2.default.writeFileSync(path, JSON.stringify(app.serializeState()), {
	            encoding: 'utf8'
	        });
	    } catch (err) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.BoardButton = exports.SoundBoard = exports.ModeChanger = exports.App = undefined;
	...
	var App = exports.App = function (_Component) {
	    ...
	    function App(props) {
	        ...
	        try {
	            for (var _iterator = _config.KEYS[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	                var key = _step.value;
	        ...
	        _this.state = {
	            mode: MODE_EDIT,
	            editingKey: null,
	            sounds: new _immutable2.default.Map(sounds)
	        };
	        return _this;
	    }
	    ...
	    _createClass(App, [{
	        ...
	        value: function render() {
	            ...
	            var sounds = _state.sounds;
	            var editingKey = _state.editingKey;


	            return _react2.default.createElement(
	                'div',
	                { className: (0, _classnames2.default)('app', 'mode-' + mode) },
	                _react2.default.createElement(SoundBoard, { sounds: sounds }),
	                editingKey !== null ? _react2.default.createElement(BoardButtonEditor, { key: sounds[editingKey] }) : null,
	                _react2.default.createElement(ModeChanger, null)
	            );
	        }
	    }]);
	...
	var ModeChanger = exports.ModeChanger = function (_Component2) {
	    _inherits(ModeChanger, _Component2);

	    function ModeChanger() {
	        _classCallCheck(this, ModeChanger);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(ModeChanger).apply(this, arguments));
	    }

	    _createClass(ModeChanger, [{
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	...
	var SoundBoard = exports.SoundBoard = function (_Component3) {
	    _inherits(SoundBoard, _Component3);

	    function SoundBoard() {
	        _classCallCheck(this, SoundBoard);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(SoundBoard).apply(this, arguments));
	    }
	    ...
	    _createClass(SoundBoard, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _config.ROWS.map(function (row, i) {
	                    return _react2.default.createElement(
	                        'div',
	                        { key: i, className: 'row' },
	                        row.map(function (key) {
	                            return _react2.default.createElement(BoardButton, {
	                                key: key,
	                                soundKey: key,
	                                sound: _this4.props.sounds.get(key)
	                            });
	                        })
	                    );
	                })
	...
	var BoardButton = exports.BoardButton = function (_Component4) {
	    _inherits(BoardButton, _Component4);

	    function BoardButton() {
	        _classCallCheck(this, BoardButton);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(BoardButton).apply(this, arguments));
	    }

	    _createClass(BoardButton, [{
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement(
	                'li',
	...
	var BoardButtonEditor = function (_Component5) {
	    _inherits(BoardButtonEditor, _Component5);

	    function BoardButtonEditor() {
	        _classCallCheck(this, BoardButtonEditor);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(BoardButtonEditor).apply(this, arguments));
	    }

	    _createClass(BoardButtonEditor, [{
	        key: 'render',
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(BoardButton, { soundKey: key, sound: sound })
	                    ),
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'fields-container' },
	                        _react2.default.createElement(FileField, null),
	                        _react2.default.createElement(IconField, null),
	                        _react2.default.createElement(ColorField, null)
	                    ),
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'volume-container' },
	                        _react2.default.createElement(VolumeField, null)
	                    )
	                ),
	                _react2.default.createElement(
	                    'div',
	                    { className: 'effects' },
	                    _react2.default.createElement(EffectEditor, { effect: 'Phaser' }),
	                    _react2.default.createElement(EffectEditor, { effect: 'Chorus' }),
	                    _react2.default.createElement(EffectEditor, { effect: 'Reverb' })
	                ),
	                _react2.default.createElement(
	                    'div',
	                    { className: 'actions' },
	    ...
	    return BoardButtonEditor;
	}(_react.Component);

	var FileField = function (_Component6) {
	    _inherits(FileField, _Component6);

	    function FileField() {
	        _classCallCheck(this, FileField);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(FileField).apply(this, arguments));
	    }
	    ...
	    _createClass(FileField, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement('input', { name: 'file', type: 'file' })
	            );
	        }
	    }]);
	...
	var IconField = function (_Component7) {
	    _inherits(IconField, _Component7);

	    function IconField() {
	        _classCallCheck(this, IconField);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(IconField).apply(this, arguments));
	    }
	    ...
	    _createClass(IconField, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement('input', { name: 'icon', type: 'file' })
	            );
	        }
	    }]);
	...
	var ColorField = function (_Component8) {
	    _inherits(ColorField, _Component8);

	    function ColorField() {
	        _classCallCheck(this, ColorField);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(ColorField).apply(this, arguments));
	    }
	    ...
	    _createClass(ColorField, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement('input', { name: 'color', type: 'color' })
	            );
	        }
	    }]);
	...
	var VolumeField = function (_Component9) {
	    _inherits(VolumeField, _Component9);

	    function VolumeField() {
	        _classCallCheck(this, VolumeField);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(VolumeField).apply(this, arguments));
	    }

	    _createClass(VolumeField, [{
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                ...
	                _react2.default.createElement('input', { name: 'volume', type: 'range' })
	            );
	        }
	    }]);
	...
	var EffectEditor = function (_Component10) {
	    _inherits(EffectEditor, _Component10);

	    function EffectEditor() {
	        _classCallCheck(this, EffectEditor);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(EffectEditor).apply(this, arguments));
	    }

	    _createClass(EffectEditor, [{
	        key: 'render',
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'label',
	                    { className: 'toggle', htmlFor: effect },
	                    _react2.default.createElement('input', { type: 'checkbox', name: effect }),
	                    _react2.default.createElement(
	                        'span',
	                        null,
	                        effect
	                ...
	                _react2.default.createElement(EffectParameter, { effect: effect, name: 'a' }),
	                _react2.default.createElement(EffectParameter, { effect: effect, name: 'b' }),
	                _react2.default.createElement(EffectParameter, { effect: effect, name: 'c' }),
	                _react2.default.createElement(EffectParameter, { effect: effect, name: 'd' })
	            );
	        }
	    }]);
	...
	var EffectParameter = function (_Component11) {
	    _inherits(EffectParameter, _Component11);

	    function EffectParameter() {
	        _classCallCheck(this, EffectParameter);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(EffectParameter).apply(this, arguments));
	    }

	    _createClass(EffectParameter, [{
	        key: 'render',
	        value: function render() {
	            var _props2 = this.props;
	            var effect = _props2.effect;
	            var name = _props2.name;


	            return _react2.default.createElement('input', { name: effect + '-' + name, type: 'number' });
	        }
	    }]);
...
/***/ function(module, exports) {
	...
	var ROWS = exports.ROWS = [['q', 'w', 'e', 'r', 't', 'y', 'u', 'i'], ['a', 's', 'd', 'f', 'g', 'h', 'j', 'k'], ['z', 'x', 'c', 'v', 'b', 'n', 'm', ',']];

	var KEYS = exports.KEYS = ROWS.reduce(function (prev, cur) {
